...
class Follower:
  ...
  def image_callback(self, msg):
    ...
    lower_white = numpy.array([ 220, 220, 220])
    ...
    if cxleft and cxright:
      if cxleft > w/4:
        ...
        if err_right_y > 7*h/8:
          self.twist.angular.z = float(err_right_x)/300 + err_right_y/1000
        else:
      ...
      err_right_y = cyright
      self.twist.linear.x = 0.4
      self.twist.angular.z = float(err_right_x)/1000 - err_right_y/10000
      old_err = False
    else:
